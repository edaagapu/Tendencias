...
\begin{figure}[h!]
	\centering
	\includegraphics[width=1.5\linewidth]{libro/capitulo4/img/PROBE.pdf}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=1.0\linewidth]{libro/capitulo4/img/PROBE_2.pdf}
	\caption{Estimaci\'on}
\end{figure}
\newpage
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=1.0\linewidth]{capitulo4/img/Gantt.pdf}
